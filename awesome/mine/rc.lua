...
globalkeys = gears.table.join(
	...
	-- Moving window focus across monitors
	...
	awful.key({ modkey }, "n", function()
		awful.spawn("thunar")
	end, { description = "open filemanager" }),
	awful.key({ modkey }, "b", function()
		awful.spawn("brave")
	end, { description = "open browser" }),
	awful.key({ modkey }, "a", function()
		awful.spawn(dir .. "/scripts/assist/instantassist.sh", false)
	...
	end, { description = "scratchpad" }),

	--- rofi
	awful.key({ modkey }, "y", function()
		awful.spawn(dir .. "/scripts/rofi/launcher")
	end, { description = "instantassist" }),
	awful.key({ modkey, "Ctrl" }, "space", function()
		awful.spawn(dir .. "/scripts/rofi/runner")
	end, { description = "open a applauncher" }),

	-- switching layouts
	awful.key({ modkey }, "t", function()
		awful.layout.set(awful.layout.suit.tile)
	end, { description = "switch to tile layout" }),
	...
	awful.key({}, "XF86MonBrightnessUp", function()
		awful.spawn(dir .. "scripts/brightness.sh up", false)
	end),
	awful.key({}, "XF86MonBrightnessDown", function()
		awful.spawn(dir .. "scripts/brightness.sh down", false)
	end),

	awful.key({}, "XF86AudioRaiseVolume", function()
		awful.spawn(dir .. "scripts/volume.sh up", false)
	end),
	awful.key({}, "XF86AudioLowerVolume", function()
		awful.spawn(dir .. "scripts/volume.sh down", false)
	end),
	awful.key({}, "XF86AudioMute", function()
		awful.spawn(dir .. "scripts/volume.sh mute", false)
	end)
)
...
clientkeys = gears.table.join(
	awful.key({ modkey, "Control" }, "f", function(c)
		...
		c:raise()
	end, { description = "toggle fullscreen (maximaze)", group = "client" }),
